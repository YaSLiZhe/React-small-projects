...
export default function App() {
  return (
    <div>
      ...
      <TextExpander isExpanded={true} className="box">
...
function TextExpander({
  ...
  const displayText = expanded ? children : children.split(" ").slice(0, collapsedNumWords).join(" ") + "...";
  return (
    <div className={className}>
      <span>{displayText}</span>
      <button style={{ color: buttonColor }} onClick={toggleCollapse}>
